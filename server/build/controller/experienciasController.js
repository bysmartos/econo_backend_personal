...
var experienciasController = {
    ...
    postExperiencia: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, titulo, imagen, descripcion, precio, duracionhoras, accesibilidad, ubicacion, transporte, duracion, experiencias, result, error_2;
    ...
    updateExperiencia: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var param, _a, titulo, imagen, descripcion, precio, duracionhoras, accesibilidad, ubicacion, transporte, duracion, experiencias, result, error_3;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 4, , 5]);
                    ...
                    res.status(400).json({ message: 'some info is missing' });
                    return [3 /*break*/, 3];
                case 1: return [4 /*yield*/, experienciasModel_1["default"].updateExperiencia(__assign({ titulo: titulo, imagen: imagen, descripcion: descripcion, precio: precio, duracionhoras: duracionhoras, accesibilidad: accesibilidad, ubicacion: ubicacion, transporte: transporte, duracion: duracion }, experiencias), param)];
                case 2:
                    result = _b.sent();
                    result
                        ? res.status(201).json({ result: result.rows })
